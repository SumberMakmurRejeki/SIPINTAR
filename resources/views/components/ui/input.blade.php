...
@php
    ...
    $base = 'block w-full rounded-[10px] bg-white px-4 py-2.5 text-[14px] text-[#0f172a] placeholder:text-[#94a3b8] caret-[#0f172a] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-60 disabled:cursor-not-allowed';
