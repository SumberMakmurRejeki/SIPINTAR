...
@section('content')
    <div class="space-y-6">
        <x-ui.page-header title="Penilaian" subtitle="Kelola penilaian essay dan hasil test." />
        ...
        <x-ui.card>
            <div class="py-12 text-center">
                ...
                <h3 class="mt-4 text-sm font-semibold text-[#080808]">Belum ada penilaian</h3>
                <p class="mt-1 text-sm text-[#5A5A5A]">Fitur Penilaian akan diimplementasikan di Session 5.</p>
            </div>
        </x-ui.card>
    </div>
@endsection
