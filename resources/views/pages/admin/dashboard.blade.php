...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach(['Total Karyawan', 'Training Aktif', 'Dalam Progress', 'Selesai'] as $label)
        ...
        <div class="rounded-lg border border-[#D8D8D8] bg-white p-12 text-center">
            <p class="text-sm text-[#5A5A5A]">Halaman dashboard admin — placeholder untuk Session 1.</p>
        </div>
    </div>
@endsection
