...
<body class="min-h-screen bg-[#f8fafc] font-sans antialiased" x-data="{ sidebarOpen: false, sidebarCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' }" @keydown.escape.window="sidebarOpen = false">
    ...
    >
        ...
        <nav class="flex flex-col gap-1 p-3 overflow-y-auto h-[calc(100%-4rem)]">
            ...
            {{-- Penilaian --}}
            <a href="{{ route('admin.grading.index') }}" class="flex items-center gap-3 rounded-[10px] px-3 py-2.5 text-[14px] font-medium transition-all {{ request()->routeIs('admin.grading.*') ? 'bg-blue-50 text-blue-600 border-l-[3px] border-blue-600' : 'text-[#64748b] hover:bg-gray-50 hover:text-[#0f172a]' }}" :class="{ '!justify-center !px-0': sidebarCollapsed }">
            ...
            {{-- Monitoring Progress --}}
            <a href="{{ route('admin.monitoring-progress.index') }}" class="flex items-center gap-3 rounded-[10px] px-3 py-2.5 text-[14px] font-medium transition-all {{ request()->routeIs('admin.monitoring-progress.*') ? 'bg-blue-50 text-blue-600 border-l-[3px] border-blue-600' : 'text-[#64748b] hover:bg-gray-50 hover:text-[#0f172a]' }}" :class="{ '!justify-center !px-0': sidebarCollapsed }">
