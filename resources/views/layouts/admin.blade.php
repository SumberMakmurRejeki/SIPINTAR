...
<body class="min-h-screen bg-white font-sans antialiased" x-data="{ sidebarOpen: false, sidebarCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' }" @keydown.escape.window="sidebarOpen = false">
    ...
    >
        ...
        <div class="flex h-14 shrink-0 items-center border-b border-[#D8D8D8] px-4" :class="{ 'justify-center px-0': sidebarCollapsed }">
            ...
            {{-- Collapsed logo icon --}}
            <a href="{{ route('admin.dashboard') }}" :class="{ hidden: !sidebarCollapsed }" class="hidden lg:flex h-8 w-8 items-center justify-center rounded-md bg-[#080808] text-white text-xs font-semibold">
                SP
            </a>
        </div>
        ...
        <nav class="flex flex-col gap-0.5 p-2 overflow-y-auto h-[calc(100%-3.5rem)]">
            {{-- Dashboard --}}
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
            ...
            <div x-data="{ open: false }">
                <button type="button" @click="open = !open" class="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-[#5A5A5A] hover:text-[#080808] transition-colors" :class="{ '!justify-center': sidebarCollapsed }">
                ...
                <div x-show="open" x-cloak x-collapse class="mt-1 ml-4 flex flex-col gap-0.5 border-l border-[#D8D8D8] pl-3" :class="{ hidden: sidebarCollapsed }">
                    <a href="{{ route('admin.master.karyawan.index') }}" class="block rounded-md px-2 py-1 text-sm transition-colors {{ request()->routeIs('admin.master.karyawan.*') ? 'bg-gray-100 text-[#080808] font-medium' : 'text-[#5A5A5A] hover:text-[#080808]' }}">Karyawan</a>
                    <a href="{{ route('admin.master.departemen.index') }}" class="block rounded-md px-2 py-1 text-sm transition-colors {{ request()->routeIs('admin.master.departemen.*') ? 'bg-gray-100 text-[#080808] font-medium' : 'text-[#5A5A5A] hover:text-[#080808]' }}">Departemen</a>
                    <a href="{{ route('admin.master.jabatan.index') }}" class="block rounded-md px-2 py-1 text-sm transition-colors {{ request()->routeIs('admin.master.jabatan.*') ? 'bg-gray-100 text-[#080808] font-medium' : 'text-[#5A5A5A] hover:text-[#080808]' }}">Jabatan</a>
                    <a href="{{ route('admin.master.admin-user.index') }}" class="block rounded-md px-2 py-1 text-sm transition-colors {{ request()->routeIs('admin.master.admin-user.*') ? 'bg-gray-100 text-[#080808] font-medium' : 'text-[#5A5A5A] hover:text-[#080808]' }}">Admin User</a>
                </div>
            </div>

            {{-- Training --}}
            <a href="{{ route('admin.training.index') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.training*') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
            ...
            {{-- Penilaian --}}
            <a href="{{ route('admin.penilaian') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.penilaian') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
            ...
            {{-- Monitoring Progress --}}
            <a href="{{ route('admin.monitoring-progress') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.monitoring-progress') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
            ...
            {{-- Laporan Training --}}
            <a href="{{ route('admin.laporan-training') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.laporan-training') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
            ...
            <div class="mt-auto border-t border-[#D8D8D8] pt-2">
                <a href="{{ route('admin.profil-password') }}" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.profil-password') ? 'bg-gray-100 text-[#080808]' : 'text-[#5A5A5A] hover:bg-gray-50 hover:text-[#080808]' }}" :class="{ '!justify-center': sidebarCollapsed }">
    ...
    <div class="flex min-w-0 flex-1 flex-col">
        ...
        <header class="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-between border-b border-[#D8D8D8] bg-white px-4">
            ...
            <div class="relative" x-data="{ open: false }" @keydown.escape.window="open = false">
                ...
                >
                    <a href="{{ route('admin.profil-password') }}" class="block px-4 py-2 text-sm text-[#080808] hover:bg-gray-50 transition-colors">Profil & Password</a>
