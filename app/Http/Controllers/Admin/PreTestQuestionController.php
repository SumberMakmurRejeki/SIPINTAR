...
use App\Http\Requests\Admin\StorePreTestQuestionRequest;
use App\Http\Requests\Admin\UpdatePreTestQuestionRequest;
...
class PreTestQuestionController extends Controller
{
    ...
    public function preview(Training $training, Test $test): View|RedirectResponse
    {
        ...
        return view('pages::admin.training.partials.pre-test-preview', compact('training', 'test'));
    }
    ...
    private function isQuestionForPreTest(Training $training, Test $test, Question $question): bool
    {
        return $this->isPreTestForTraining($training, $test) && $question->test_id === $test->id;
    }
